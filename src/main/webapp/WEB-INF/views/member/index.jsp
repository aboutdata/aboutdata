...
<body class="">
                  ...
                  <div class="dropdown dropup wrapper-sm clearfix">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <span class="thumb-sm avatar pull-left m-l-xs">                        
                        <img src="${pageContext.request.contextPath}/assets/images/a3.png" class="dker" alt="...">
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/jPlayer/demo.js"></script>
</body>
</html>
