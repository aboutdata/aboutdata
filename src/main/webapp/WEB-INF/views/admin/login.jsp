...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/bootstrap3/css/bootstrap.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/bootstrap3/css/font-awesome.min.css" />
<!-- CUSTOM STYLES-->
<link
	href="${pageContext.request.contextPath}/assets/admin/css/login.css"
	rel="stylesheet" />
</head>
<body>
	<div class="container">
	...
	<!-- BOOTSTRAP SCRIPTS -->
	<script
		src="${pageContext.request.contextPath}/assets/admin/js/jquery.js"></script>
