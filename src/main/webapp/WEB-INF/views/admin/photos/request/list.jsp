...
<html lang="en">
	...
	<body class="no-skin">
						...
						<div class="col-xs-12">
							...
							<div>
								<ul class="ace-thumbnails clearfix">
									...
									<li>
										<a href="${pageContext.request.contextPath}/resources/images/gallery/image-1.jpg" title="Photo Title" data-rel="colorbox">
											<img alt="150x150" src="${pageContext.request.contextPath}/resources/images/gallery/thumb-1.jpg" />
										</a>
									...
									<li>
										<a href="${pageContext.request.contextPath}/resources/images/gallery/image-2.jpg" data-rel="colorbox">
											<img alt="150x150" src="${pageContext.request.contextPath}/resources/images/gallery/thumb-2.jpg" />
											<div class="text">
									...
									<li>
										<a href="${pageContext.request.contextPath}/resources/images/gallery/image-3.jpg" data-rel="colorbox">
											<img alt="150x150" src="${pageContext.request.contextPath}/resources/images/gallery/thumb-3.jpg" />
											<div class="text">
												<div class="inner">Sample Caption on Hover</div>
											</div>
										</a>
									...
									<!-- /section:pages/gallery.caption -->
									<li>
										<a href="${pageContext.request.contextPath}/resources/images/gallery/image-4.jpg" data-rel="colorbox">
											<img alt="150x150" src="${pageContext.request.contextPath}/resources/images/gallery/thumb-4.jpg" />
											<div class="tags">
									...
									<li>
										<div>
											<img alt="150x150" src="${pageContext.request.contextPath}/resources/images/gallery/thumb-5.jpg" />
											<div class="text">
												<div class="inner">
													<span>Some Title!</span>

													<br />
													<a href="${pageContext.request.contextPath}/resources/images/gallery/image-5.jpg" data-rel="colorbox">
									...
									<li>
										<a href="${pageContext.request.contextPath}/resources/images/gallery/image-6.jpg" data-rel="colorbox">
											<img alt="150x150" src="${pageContext.request.contextPath}/resources/images/gallery/thumb-6.jpg" />
										</a>
									...
									<li>
										<a href="${pageContext.request.contextPath}/resources/images/gallery/image-1.jpg" data-rel="colorbox">
											<img alt="150x150" src="${pageContext.request.contextPath}/resources/images/gallery/thumb-1.jpg" />
										</a>
		...
		<!--[if !IE]> -->
		<script type="text/javascript">
			window.jQuery || document.write("<script src='${pageContext.request.contextPath}/resources/js/jquery.min.js'>"+"<"+"/script>");
		</script>
...
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='${pageContext.request.contextPath}/resources/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
